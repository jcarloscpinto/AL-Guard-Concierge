...
- URL: `https://figma.com/design/YOUR_FIGMA_FILE_KEY/DesignSystem?node-id=42-15`
...
User says: "Implement this Figma button component: https://figma.com/design/YOUR_FIGMA_FILE_KEY/DesignSystem?node-id=42-15"

**Actions:**

1. Parse URL to extract fileKey=`YOUR_FIGMA_FILE_KEY` and nodeId=`42-15`
2. Run `get_design_context(fileKey="YOUR_FIGMA_FILE_KEY", nodeId="42-15")`
3. Run `get_screenshot(fileKey="YOUR_FIGMA_FILE_KEY", nodeId="42-15")` for visual reference
...
User says: "Build this dashboard: https://figma.com/design/YOUR_DASHBOARD_FILE_KEY/Dashboard?node-id=10-5"

**Actions:**

1. Parse URL to extract fileKey=`YOUR_DASHBOARD_FILE_KEY` and nodeId=`10-5`
2. Run `get_metadata(fileKey="YOUR_DASHBOARD_FILE_KEY", nodeId="10-5")` to understand the page structure
3. Identify main sections from metadata (header, sidebar, content area, cards) and their child node IDs
4. Run `get_design_context(fileKey="YOUR_DASHBOARD_FILE_KEY", nodeId=":childNodeId")` for each major section
5. Run `get_screenshot(fileKey="YOUR_DASHBOARD_FILE_KEY", nodeId="10-5")` for the full page
